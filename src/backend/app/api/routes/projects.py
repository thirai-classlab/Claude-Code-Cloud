...
async def update_project(
    ...
    try:
        ...
        logger.error("Error updating project", error=str(e))
        raise HTTPException(status_code=500, detail="Internal server error")
...
async def get_project_sessions(
    ...
    try:
        ...
        logger.error("Error getting project sessions", error=str(e))
        raise HTTPException(status_code=500, detail="Internal server error")
...
async def create_project_session(
    ...
    try:
        ...
        logger.error("Error creating project session", error=str(e))
        raise HTTPException(status_code=500, detail="Internal server error")
...
async def delete_project_session(
    ...
    try:
        ...
        logger.error("Error deleting project session", error=str(e))
        raise HTTPException(status_code=500, detail="Internal server error")
