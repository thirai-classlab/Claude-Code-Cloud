...
import { PublicAccessSettings } from '../project/PublicAccessSettings';
...
const EDITOR_TAB_CONFIG: { id: EditorTab; labelKey: string; icon: React.ReactNode }[] = [
  ...
  {
    id: 'public',
    labelKey: 'editor.tabs.publicAccess',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {activeEditorTab === 'public' && (
          <PublicAccessSettings projectId={projectId} />
        )}
      </div>
    </div>
  );
