...
- [1. 概要](#1-概要)
  - [1.1 目的](#11-目的)
  - [1.2 アクセス方法](#12-アクセス方法)
- [2. 画面構成](#2-画面構成)
  - [2.1 全体レイアウト](#21-全体レイアウト)
  - [2.2 URL構造](#22-url構造)
- [3. セクション詳細](#3-セクション詳細)
  - [3.1 アカウント設定](#31-アカウント設定)
  - [3.2 インテグレーション](#32-インテグレーション)
  - [3.3 GitHub連携詳細](#33-github連携詳細)
  - [3.4 テンプレート管理](#34-テンプレート管理)
  - [3.5 セキュリティ](#35-セキュリティ)
  - [3.6 外観設定](#36-外観設定)
- [4. データモデル](#4-データモデル)
  - [4.1 GitHub PAT管理](#41-github-pat管理)
  - [4.2 ER図](#42-er図)
- [5. API設計](#5-api設計)
  - [5.1 GitHub PAT管理API](#51-github-pat管理api)
  - [5.2 アカウント管理API](#52-アカウント管理api)
  - [5.3 セッション管理API](#53-セッション管理api)
- [6. フロントエンド設計](#6-フロントエンド設計)
  - [6.1 新規コンポーネント](#61-新規コンポーネント)
  - [6.2 Store設計](#62-store設計)
- [7. サイドバー設定ボタン](#7-サイドバー設定ボタン)
  - [7.1 Sidebarコンポーネント更新](#71-sidebarコンポーネント更新)
- [変更履歴](#変更履歴)
