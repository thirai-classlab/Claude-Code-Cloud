...
- [2. コンポーネント設計](#2-コンポーネント設計)
  - [2.1 ChatContainer.tsx](#21-chatcontainertsx)
  - [2.2 MessageBubble.tsx](#22-messagebubbletsx)
  - [2.3 CodeServerEditor.tsx](#23-codeservereditortsx)
  - [2.4 EditorContainer.tsx](#24-editorcontainertsx)
  - [2.5 MonacoEditor.tsx（フォールバック用）](#25-monacoeditortsxフォールバック用)
  - [2.6 FileTree.tsx](#26-filetreetsx)
  - [2.7 MainLayout.tsx](#27-mainlayouttsx)
- [3. 状態管理設計](#3-状態管理設計)
  - [3.1 chatStore.ts](#31-chatstorets)
  - [3.2 fileStore.ts](#32-filestorets)
  - [3.3 projectStore.ts](#33-projectstorets)
  - [3.4 sessionStore.ts](#34-sessionstorets)
  - [3.5 uiStore.ts](#35-uistorets)
- [4. WebSocket接続管理](#4-websocket接続管理)
  - [4.1 useWebSocket.ts](#41-usewebsocketsts)
  - [4.2 WebSocketクライアント](#42-websocketクライアント)
- [5. UIデザイン仕様](#5-uiデザイン仕様)
  - [5.1 カラースキーム](#51-カラースキーム)
  - [5.2 レイアウト仕様](#52-レイアウト仕様)
  - [5.3 コンポーネントスタイル](#53-コンポーネントスタイル)
- [6. 型定義](#6-型定義)
  - [6.1 message.ts](#61-messagets)
  - [6.2 websocket.ts](#62-websocketts)
  - [6.3 file.ts](#63-filets)
  - [6.4 project.ts](#64-projectts)
  - [6.5 session.ts](#65-sessionts)
- [7. ルーティング設計](#7-ルーティング設計)
  - [7.1 App Router構造](#71-app-router構造)
- [8. パフォーマンス最適化](#8-パフォーマンス最適化)
  - [8.1 仮想スクロール](#81-仮想スクロール)
  - [8.2 コード分割](#82-コード分割)
  - [8.3 メモ化](#83-メモ化)
  - [8.4 デバウンス](#84-デバウンス)
- [9. パッケージ構成](#9-パッケージ構成)
  - [9.1 package.json](#91-packagejson)
  - [9.2 tsconfig.json](#92-tsconfigjson)
  - [9.3 tailwind.config.ts](#93-tailwindconfigts)
- [10. 実装優先順位](#10-実装優先順位)
- [11. 開発環境セットアップ](#11-開発環境セットアップ)
  - [11.1 必要な環境](#111-必要な環境)
  - [11.2 推奨VS Code拡張機能](#112-推奨vs-code拡張機能)
  - [11.3 開発開始コマンド](#113-開発開始コマンド)
- [変更履歴](#変更履歴)
