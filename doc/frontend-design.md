...
flowchart LR
    subgraph 変更履歴
        ...
        V11["v1.1 (2025-12-21)"] --> V11D["ドキュメント形式の統一<br/>ステータス情報追加"]
    end
```
...
**ドキュメント管理情報**
- **ファイル名:** frontend-design.md
- **保存場所:** doc_draft/ → doc/（承認後）
- **関連ドキュメント:** architecture-design.md, backend-design.md, screen-design.md
- **次のステップ:** バックエンドAPI設計書との連携確認、プロトタイプ実装開始
